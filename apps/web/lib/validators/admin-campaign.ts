...
export const adminCampaignCreateSchema = z.object({
  ...
  creatorBriefTitle: z.string().trim().min(3).max(160),
  creatorBriefDescription: z.string().trim().min(10).max(3000),
...
export const adminCampaignUpdateSchema = z.object({
  ...
  creatorBriefTitle: z.string().trim().min(3).max(160).optional(),
  creatorBriefDescription: z.string().trim().min(10).max(3000).optional(),
