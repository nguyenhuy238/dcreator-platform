...
const adminNavItems: readonly NavItem[] = [
  ...
  { href: "/admin/brand-consultations", label: "Tư vấn Brand", description: "Lead tư vấn 1:1 từ landing page", icon: "IdentificationCard" },
  { href: "/admin/payouts", label: "Payouts", description: "Danh sách yêu cầu payout", icon: "Bank" },
...
const breadcrumbLabelMap: Record<string, string> = {
  ...
  "/admin/brand-consultations": "Tư vấn Brand",
