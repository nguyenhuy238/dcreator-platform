...
const brandNavItems: readonly NavItem[] = [
  ...
  { href: "/dashboard/brand/mission-reviews", label: "Duyệt nhiệm vụ Creator", description: "Duyệt nhận nhiệm vụ, video và hoàn thành" },
...
const adminNavItems: readonly NavItem[] = [
  ...
  { href: "/admin/mission-reviews", label: "Duyệt nhiệm vụ Creator", description: "Gộp nhận nhiệm vụ, duyệt video và duyệt hoàn thành" },
