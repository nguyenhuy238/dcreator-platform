...
const adminNavItems: readonly NavItem[] = [
  ...
  { href: "/admin/proofs", label: "Quản lý nhiệm vụ và bằng chứng", description: "Quản lý quy trình bằng chứng và tranh chấp", icon: "ClipboardText", activePrefixes: ["/admin/proofs", "/admin/content-review"] },
  { href: "/admin/vouchers", label: "Quản lý voucher / quà tặng", description: "Theo dõi và can thiệp voucher / quà tặng", icon: "Gift" },
...
const breadcrumbLabelMap: Record<string, string> = {
  ...
  "/admin/proofs": "Quản lý nhiệm vụ và bằng chứng",
