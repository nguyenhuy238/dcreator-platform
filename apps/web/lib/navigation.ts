...
const creatorNavItems: readonly NavItem[] = [
  ...
  { href: "/dashboard/creator/proofs", label: "Proof của tôi", description: "Nộp proof và lịch sử duyệt" },
...
const adminNavItems: readonly NavItem[] = [
  ...
  { href: "/admin/content-review", label: "Duyệt proof / content", description: "Duyệt proof/video" },
...
const WORKSPACES: readonly WorkspaceConfig[] = [
  ...
  },
  {
    ...
    description: "Quản lý job, nhiệm vụ, proof và hoa hồng",
...
const breadcrumbLabelMap: Record<string, string> = {
  ...
  "/dashboard/creator/proofs": "Proof của tôi",
