...
import { rejectMissionTranscriptReviewByBrand } from "@/lib/services/creator-mission.service";
...
export async function POST(request: NextRequest, { params }: Props) {
  try {
    ...
    return ok(await rejectMissionTranscriptReviewByBrand(actor.id, id, body.feedback));
  } catch (error) {
