...
export default function AdminMissionHistoryPage() {
  ...
  async function loadDetail(id: string) {
    ...
    try {
      const res = await fetch(`/api/admin/mission-history/${id}`, { cache: "no-store" });
  ...
  return (
    <>
      <PageHeader title="Lịch sử nhiệm vụ Creator" subtitle="Xem toàn bộ Creator Mission trong hệ thống (chỉ xem, không thao tác)." />
